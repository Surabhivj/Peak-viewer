...
def main():
    ...
    if uploaded_file is not None:
        try:
            ...
            #covert to mv
            CH1 = processed_data.iloc[:, 1] * 1000
            CH2 = processed_data.iloc[:, 2] * 1000
            ...
            fig = make_subplots(rows=3, cols=2, 
                                subplot_titles=("Peaks: " + str(len(peaks_CH1)), "Histogram: Peak heights", 
                                                "Peaks: " + str(len(peaks_CH2)), "Histogram: Peak heights"), #"Peaks: " + str(len(peaks_CH4)), "Histogram: Peak heights"),
